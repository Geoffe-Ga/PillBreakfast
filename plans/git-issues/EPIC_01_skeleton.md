...
- [ ] #NNN — Skeleton: Create paired Xcode project, App Group, capabilities, and placeholder views (EPIC_01_ISSUE_01).
- [ ] #NNN — Wire empty SwiftData `ModelContainer` against the App Group container URL (EPIC_01_ISSUE_02).
- [ ] #NNN — Stub `WatchConnectivityCoordinator` actor on both targets with activation logging (EPIC_01_ISSUE_03).
- [ ] #NNN — Update build / test / run documentation in `CLAUDE.md` and add a top-level `README.md` (EPIC_01_ISSUE_04).
