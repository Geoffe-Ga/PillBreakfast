...
- [ ] #NNN — Skeleton: Add a `Submission/` folder containing the asset checklist, screenshot script, and a soak diary template — wired but with empty content (EPIC_10_ISSUE_01).
- [ ] #NNN — App icons + asset catalog validation across all required watchOS and iOS sizes (EPIC_10_ISSUE_02).
- [ ] #NNN — Screenshots + marketing copy for the TestFlight / App Store listing (EPIC_10_ISSUE_03).
- [ ] #NNN — Crash reporting decision documented as an `architectural-decisions` trade-off, default MetricKit implemented (EPIC_10_ISSUE_04).
- [ ] #NNN — Privacy nutrition labels matching real data collection (EPIC_10_ISSUE_05).
- [ ] #NNN — Mutation testing harness via `scripts/mutate.sh` targeting the three critical modules with score >= 85% (EPIC_10_ISSUE_06).
- [ ] #NNN — 5-day soak test on real hardware + soak diary capture (EPIC_10_ISSUE_07).
