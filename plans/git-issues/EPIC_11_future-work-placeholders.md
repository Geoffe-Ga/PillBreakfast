...
- [ ] #NNN — Future: Pill imagery via NLM RxImage API (SPEC §12.1) (EPIC_11_ISSUE_01).
- [ ] #NNN — Future: iCloud sync for multi-device via CloudKit-backed SwiftData (SPEC §12.2) (EPIC_11_ISSUE_02).
- [ ] #NNN — Future: Caregiver mode (SPEC §12.3) (EPIC_11_ISSUE_03).
- [ ] #NNN — Future: Health dose readback enrichment via `HKAnchoredObjectQuery` (SPEC §12.4) (EPIC_11_ISSUE_04).
- [ ] #NNN — Future: Apple Watch Ultra Action Button binding (SPEC §12.5) (EPIC_11_ISSUE_05).
- [ ] #NNN — Future: File Apple Feedback Assistant request for `HKMedicationDoseEvent` write capability (SPEC §12.6) (EPIC_11_ISSUE_06).
